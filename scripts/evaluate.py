...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="./models/qwen3-8b-finetuned")
    parser.add_argument("--base_tokenizer_path", type=str, default="/data/lys/models/Qwen3-8B")
